...
print(f"Total number of indels in sample 1: {indel_counter}") # (45)
print(f"Distance from first to last indel: {min_distance[0], min_distance[-1]}") # 1245282 to 1255000
...
percentage = (alignment_counter / total_positions) * 100 if total_positions > 0 else 0
