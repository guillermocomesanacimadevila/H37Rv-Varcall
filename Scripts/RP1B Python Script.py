...
# First, mean depth per 1kb to 3dp #Compute P-value
print(f"Sample 1 mean: {round(coverage_sample1.coverage_mean.mean(), 3)}") # 50.106
print(f"Sample 2 mean: {round(coverage_sample2.coverage_mean.mean(), 3)}") # 49.997
print(f"Sample 3 mean: {round(coverage_sample3.coverage_mean.mean(), 3)}") # 49.997
...
# In order to filter through the data frames, itñs easier to do it if .vcf into .csv
